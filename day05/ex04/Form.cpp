...
/*   Updated: 2019/10/08 17:53:00 by ashypilo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::NotBureaucratSignException::NotBureaucratSignException()
{
    return ;
}

Form::NotBureaucratSignException::NotBureaucratSignException(const NotBureaucratSignException& over)
{
    *this = over;
    return ;
}

Form::NotBureaucratSignException::~NotBureaucratSignException() throw()
{
    return ;
}

Form::NotBureaucratSignException& Form::NotBureaucratSignException::operator=(const Form::NotBureaucratSignException& over)
{
    exception::operator=(over);
    return (*this);
}

const char* Form::NotBureaucratSignException::what() const throw()
{
    return ("Not sign on the bureacrat");
}
...
{
    if (this->indicat == false)
        throw Form::NotBureaucratSignException();
    if (executor.getGrade() > this->getGrade_execute())
        throw Form::GradeTooLowException();
    this->action();
}